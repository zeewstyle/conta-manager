...
var _CSSPropertyOperations = __webpack_require__(23);

var _clean = __webpack_require__(49);

var _clean2 = _interopRequireDefault(_clean);

var _plugins = __webpack_require__(50);

var _hash = __webpack_require__(67);
...
const tabs_1 = __webpack_require__(37);
const lancamentoDeValores_1 = __webpack_require__(38);
let contas = [
...
class App extends React.Component {
    render() {
        ...
        return (React.createElement("div", null,
            ...
            React.createElement("div", { className: "ui main container" },
                React.createElement(lancamentoDeValores_1.default, { contas: listaContas }))));
    }
}
exports.default = App;
ReactDOM.render(React.createElement(App, null, "text"), document.getElementById("app"));
...
var m=__webpack_require__(2),n=__webpack_require__(10),p=__webpack_require__(3),q="function"===typeof Symbol&&Symbol["for"],r=q?Symbol["for"]("react.element"):60103,t=q?Symbol["for"]("react.call"):60104,u=q?Symbol["for"]("react.return"):60105,v=q?Symbol["for"]("react.portal"):60106,w=q?Symbol["for"]("react.fragment"):60107,x="function"===typeof Symbol&&Symbol.iterator;
...
*/
var aa=__webpack_require__(1),l=__webpack_require__(15),B=__webpack_require__(2),C=__webpack_require__(3),ba=__webpack_require__(16),da=__webpack_require__(17),ea=__webpack_require__(18),fa=__webpack_require__(19),ia=__webpack_require__(20),D=__webpack_require__(10);
...
class Tab extends React.Component {
    ...
    render() {
        return React.createElement("a", { className: this.props.isActive ? "item active" : "item", onClick: this.props.onActiveTab }, this.props.title);
    }
}
exports.Tab = Tab;
class Tabs extends React.Component {
    ...
    renderTab() {
        return this.state.tabs.map((tab) => {
            return (React.createElement(Tab, { isActive: this.isActive(tab.index), title: tab.title, key: tab.index, onActiveTab: this.setActiveTab.bind(this, tab.index) }));
        });
    }
    render() {
        return (React.createElement("div", { className: "ui inverted" },
            React.createElement("div", { className: "ui stackable   menu" },
                React.createElement("div", { className: "header item" }, "Conta Manager"),
                this.renderTab())));
    }
}
exports.Tabs = Tabs;
...
Object.defineProperty(exports, "__esModule", { value: true });
const React = __webpack_require__(1);
const componentes_1 = __webpack_require__(39);
const lancamentos_1 = __webpack_require__(40);
const react_toastify_1 = __webpack_require__(41);
class LancamentoDeValores extends React.Component {
    constructor(props) {
        super(props);
        var transacaoAtual = {
            operacao: {
                codigo: componentes_1.eTipoTransacao.credito,
                descricao: "Crédito"
            },
            banco: {
                codigo: 1,
    ...
    notifyOperacaoRealizada() {
        react_toastify_1.toast.success(`${this.state.transacaoAtual.operacao.descricao} de ${this.state.transacaoAtual.valor} no banco ${this.state.transacaoAtual.banco.descricao}`);
    }
    notifyErroValorZero() {
        react_toastify_1.toast.error("Não é possível inserir valor zero!");
    }
    handleClickButton(e) {
        e.preventDefault();
        if (this.state.transacaoAtual.valor == 0) {
            ...
            this.setState(prevState => ({
                transacaoAtual: Object.assign({}, prevState.transacaoAtual, { valor: 0 })
            }));
        }
    }
    handleKeyDown(e) {
    ...
    render() {
        return (React.createElement("section", null,
            ...
            React.createElement("form", { className: "ui form" },
                React.createElement("h1", { className: "ui header" }, "Lan\u00E7amento de valores"),
                React.createElement("div", { className: "field" },
                    React.createElement("div", { className: "four fields" },
                        React.createElement("div", { className: "field" },
                            React.createElement("label", null, "Banco"),
                            React.createElement("select", { value: this.state.transacaoAtual.banco.codigo, name: "banco", onChange: this.handleChangeSelect, className: "ui compact selection dropdown" }, this.props.contas.map(item => (React.createElement("option", { key: item.codigo, value: item.codigo }, item.descricao))))),
                        React.createElement("div", { className: "field" },
                            React.createElement("label", null, "Valor"),
                            React.createElement("input", { type: "number", min: "0.00", max: "10000.00", step: "0.01", placeholder: "Valor", value: this.state.transacaoAtual.valor, onChange: this.handleChangeInput, onKeyDown: this.handleKeyDown })),
                        React.createElement("div", { className: "field" },
                            React.createElement("label", null, "Opera\u00E7\u00E3o"),
                            React.createElement("select", { value: this.state.transacaoAtual.operacao.codigo, name: "operacao", onChange: this.handleChangeSelect, className: "ui compact selection dropdown" },
                                React.createElement("option", { value: componentes_1.eTipoTransacao.credito }, "Cr\u00E9dito"),
                                React.createElement("option", { value: componentes_1.eTipoTransacao.debito }, "D\u00E9bito"))))),
                React.createElement("button", { className: "ui primary button", onClick: this.handleClickButton }, "Adicionar")),
            React.createElement("div", null,
                React.createElement(lancamentos_1.default, { transacoes: this.state.transacoes }))));
    }
}
exports.default = LancamentoDeValores;
...
Object.defineProperty(exports, "__esModule", { value: true });
var eTipoTransacao;
(function (eTipoTransacao) {
    eTipoTransacao[eTipoTransacao["credito"] = 1] = "credito";
    eTipoTransacao[eTipoTransacao["debito"] = 2] = "debito";
})(eTipoTransacao || (eTipoTransacao = {}));
exports.eTipoTransacao = eTipoTransacao;
;
...
class Lancamentos extends React.Component {
    render() {
        return (React.createElement("table", { className: "ui single line table" },
            React.createElement("thead", null,
                React.createElement("tr", null,
                    React.createElement("th", null, "Banco"),
                    React.createElement("th", null, "Tipo de transa\u00E7\u00E3o"),
                    React.createElement("th", null, "Valor"))),
            React.createElement("tbody", null, this.props.transacoes.map((x, y) => (React.createElement("tr", { key: y },
                React.createElement("td", null, x.banco.descricao),
                React.createElement("td", null, x.operacao.descricao),
                React.createElement("td", null, x.valor))))),
            React.createElement("tfoot", null,
                React.createElement("tr", null,
                    React.createElement("th", null, "Saldo"),
                    React.createElement("th", null),
                    React.createElement("th", null, this.props.transacoes.map(x => x.valor).reduce((x, y) => Number(x) + Number(y), 0))))));
    }
}
...
var _ToastContainer = __webpack_require__(42);

var _ToastContainer2 = _interopRequireDefault(_ToastContainer);

var _toaster = __webpack_require__(77);
...
var _TransitionGroup = __webpack_require__(68);
...
var _DefaultCloseButton = __webpack_require__(72);

var _DefaultCloseButton2 = _interopRequireDefault(_DefaultCloseButton);

var _DefaultTransition = __webpack_require__(73);
...
var _propValidator = __webpack_require__(25);
...
var _CSSProperty = __webpack_require__(47);
...
var _prefixer = __webpack_require__(51);
...
var _staticData = __webpack_require__(52);

var _staticData2 = _interopRequireDefault(_staticData);

var _prefixProperty = __webpack_require__(53);

var _prefixProperty2 = _interopRequireDefault(_prefixProperty);

var _prefixValue = __webpack_require__(54);
...
var _hyphenateProperty = __webpack_require__(65);
...
var _animation2 = __webpack_require__(76);
